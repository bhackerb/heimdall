...
from beorn.scanner import PendingUpdate
...
def hold_packages(config: BeornConfig) -> list[str]:
...
def apply_updates(packages: list[PendingUpdate], config: BeornConfig) -> UpdateResult:
