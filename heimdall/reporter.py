...
from heimdall.config import HeimdallConfig, STATE_DIR
from heimdall.scanner import ScanResult
from heimdall.security import SecurityReport
...
def report_to_mithrandir(
    ...
    url = f"{config.mithrandir.url.rstrip('/')}/api/heimdall/report"
    ...
    payload = {
        ...
        "params": {
            ...
            "arguments": {
                ...
                "source_type": "agent",
                "source_agent": "claude",
                "tags": ["heimdall", "security", config.hostname],
            },
        },
        "id": int(time.time()),
    }
